...
$(document).ready(function(){
    $('.news__slider').slick({
        autoplay: true,
        dots: true,
        prevArrow: '<div class="arrow-container arrow-container-left"><img class="slider__arrow" src="./images/icons/arrow_left.png" alt="left arrow"></div>',
        nextArrow: '<div class="arrow-container arrow-container-right"><img class="slider__arrow" src="./images/icons/arrow_right.png" alt="left arrow"></div>',
    });
  });